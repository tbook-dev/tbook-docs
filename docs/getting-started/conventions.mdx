...
| `vault_paused` | 409 | Vault not accepting new deposits/redemptions; claim and cancel stay open |
...
| `upstream_unavailable` | 502 | An upstream chain RPC request failed. Retryable |
