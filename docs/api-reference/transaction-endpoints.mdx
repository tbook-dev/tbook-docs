...
| `summary` | object? | human-checkable amounts — see each endpoint for its fields; price-derived fields (`sharePrice`, `estimatedShares`) are best-effort and may be absent if the price source is briefly unavailable |
...
```json
{
  ...
  "summary": { "amount": "100", "sharePrice": "1.0275", "estimatedShares": "97.3236" },
