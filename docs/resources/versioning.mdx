...
SDK packages (`@tbook-dev/vault-sdk`, `@tbook-dev/vault-sdk-sui`, `@tbook-dev/vault-node`, `@tbook-dev/vault-react`) follow semver independently of the API version; each release documents the API contract version it targets.
