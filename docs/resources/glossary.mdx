...
| **Rail** | The path from the funding chain to the asset. TBook vaults use `direct`: the account's USDC and the vault live on the same chain. |
| **Vault** | An investable instance of an asset on a rail (`rcusdp-sui`, `xaua-sui`). |
